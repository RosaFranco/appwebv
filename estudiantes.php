...
$cedulaUsuar= $_SESSION['idcedulaUser'];
                ...
                <div class="panel-heading">
                  ...
                  ?>
                    ...
                    <div class="btn-group pull-left">
                      ...
                      <button  <?php echo $etiqueta?> type='button' class="btn btn-info" data-toggle="modal" onclick="NuevoEstudiante();" style="background: #42a8e3e0"><i class="bi bi-plus-circle-fill"></i> Registrar Estudiante</button>
